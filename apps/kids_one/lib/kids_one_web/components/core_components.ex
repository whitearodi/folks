defmodule KidsOneWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(KidsOneWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(KidsOneWeb.Gettext, "errors", msg, opts)
    end
  end
